...
Item
{
    ...
    Flow
    {
        ...
        Label
        {
            id: pcsqty
            height: UM.Theme.getSize("setting_control").height;
            text: UM.ActiveTool.properties.getValue("PcsQty");
            font: UM.Theme.getFont("default");
            color: UM.Theme.getColor("x_axis");
            verticalAlignment: Text.AlignVCenter;
            renderType: Text.NativeRendering
    ...
    Grid
    {
        ...
        function evaluateTextChange(text, lastEnteredValue, valueName, scaleName)
        {
            ...
            if (parsedValue > 0 && ! UM.ActiveTool.properties.getValue("NonUniformScale"))
            {
                ...
                var x = UM.ActiveTool.properties.getValue("ScaleX");
                var y = UM.ActiveTool.properties.getValue("ScaleY");
                var z = UM.ActiveTool.properties.getValue("ScaleZ");
        ...
        TextField
        {
            ...
            onEditingFinished:
            {
                ...
                var modified_text = text.replace(",", ".") // User convenience. We use dots for decimal values
                UM.ActiveTool.setProperty("ScaleX", modified_text);
            }
        ...
        TextField
        {
            ...
            {
                var modified_text = text.replace(",", ".") // User convenience. We use dots for decimal values
                UM.ActiveTool.setProperty("ScaleY", modified_text);
            }
        ...
        Binding
        {
            ...
            value: base.roundFloat(UM.ActiveTool.properties.getValue("ScaleX"), 4)
        }
        ...
        Binding
        {
            ...
            value: base.roundFloat(UM.ActiveTool.properties.getValue("ScaleY"), 4)
        }
        ...
        Binding
        {
            ...
            value: base.roundFloat(UM.ActiveTool.properties.getValue("ScaleZ"), 4)
        }
    }
}
