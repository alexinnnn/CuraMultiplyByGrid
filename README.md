# CuraMultiplyByGrid
Cura Плагин для размножения детали сеткой на весь стол автоматически без поворота. Размножение в куре настолько ужастно реализовано, что пришлось сделать свой простой плагин, т.к. существующих не нашел.
